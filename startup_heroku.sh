...
export APP_NAME="calculators-pr-$PR"
...
echo
echo "# Configuring Heroku ready for Calculators"
echo
heroku config:set \
--app $APP_NAME \
...
export CALCULATOR_TO_OPEN="child-benefit-tax-calculator"
open $HEROKU_URL$CALCULATOR_TO_OPEN
