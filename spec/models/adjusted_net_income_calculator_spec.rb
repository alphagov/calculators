...
describe AdjustedNetIncomeCalculator do
  ...
  describe "adjusted_net_income" do
    it "should calculate with minimal parameters" do
      AdjustedNetIncomeCalculator.new(:gross_income => "£60,000").adjusted_net_income.should == 60000
    end
    it "should ignore other params" do
      AdjustedNetIncomeCalculator.new(:foo => "bar").adjusted_net_income.should == 0
    end
    it "should calculate parsed parameters" do
      ...
      ).adjusted_net_income.should == 64750
    end
  end
