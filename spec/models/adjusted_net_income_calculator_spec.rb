...
describe AdjustedNetIncomeCalculator, type: :model do
  describe "adjusted_net_income" do
    it "should calculate with minimal parameters" do
      expect(AdjustedNetIncomeCalculator.new(gross_income: "£60,000").calculate_adjusted_net_income).to eq(60_000)
    end
    ...
    it "should calculate parsed parameters" do
      ...
      expect(calc.gross_income).to eq(60_000)
      ...
      expect(calc.calculate_adjusted_net_income).to eq(65_625)
    end
  end
end
